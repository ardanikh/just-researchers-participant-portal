...
export default function Consent() {
  ...
  return (
    <div className="px-4 pb-24 pt-4">
      ...
      <div className="mb-5">
        <h2 className="mb-2 flex items-center gap-1.5 text-sm font-semibold text-trust">
      ...
      <div className="mb-5">
        ...
        <p className="text-sm text-muted-foreground pl-1">{study.recordingInfo}</p>
      </div>
      ...
      <div className="mb-6 flex items-start gap-3">
        ...
        />
        <label htmlFor="consent" className="text-sm text-foreground leading-tight cursor-pointer">
